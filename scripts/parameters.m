...
%   i-th segment.
image_path = {'Z:/projects/tracking_code/submission2/ctc_hela/training_raw/01/'};
...
wells_to_track = allcomb(1:1, 1:1, 1:1);

% frames_to_track: Frame IDs.
frames_to_track = 0:91;
...
training_data_path = {'Z:/projects/tracking_code/submission2/documentation/tutorial_to_upload/training_data/training_data_11_50.mat'};

% output_path: Path to the folder storing the output MAT files.
output_path = 'Z:/projects/tracking_code/submission2/documentation/tutorial_to_upload/results/';
...
mask_path = 'Z:/projects/tracking_code/submission2/documentation/tutorial_to_upload/mask/';
...
%   Use empty character ('') if not generating this output.
%   Suggested for evaluating the accuracy of segmentation.
ellipse_movie_path = 'Z:/projects/tracking_code/submission2/documentation/tutorial_to_upload/ellipse_movie/';
...
seg_info_path = 'Z:/projects/tracking_code/submission2/documentation/tutorial_to_upload/seg_info/';
...
vistrack_path = 'Z:/projects/tracking_code/submission2/documentation/tutorial_to_upload/vistrack/';
...
background_subtraction_method = 'min';
